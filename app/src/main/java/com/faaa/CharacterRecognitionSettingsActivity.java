...
public class CharacterRecognitionSettingsActivity extends  CharacterRecognitionAppCompatPreferenceActivity  implements SharedPreferences.OnSharedPreferenceChangeListener {
