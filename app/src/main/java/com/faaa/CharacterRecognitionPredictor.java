...
public class CharacterRecognitionPredictor {
    private static final String TAG = CharacterRecognitionPredictor.class.getSimpleName();
    ...
    public CharacterRecognitionPredictor() {
    }
    ...
    protected boolean loadModel(Context appCtx, String modelPath, int cpuThreadNum, String cpuPowerMode) {
        ...
        Log.i("Error Charactor Reconition Predictor", "model path " + config.detModelFilename + " ; " + config.recModelFilename);
        Log.e("Error Charactor Reconition Predictor", "model path " + config.detModelFilename + " ; " + config.recModelFilename);
        Log.i("Error Charactor Reconition Predictor", "model path " + config.detModelFilename + " ; " + config.recModelFilename);
        config.cpuPower = cpuPowerMode;
        Log.i(" Charactor Reconition Predictor", "TRUE");
