...
public class OCRPredictorNative {
    ...
    public OCRPredictorNative(Config config) {
        this.config = config;
        Log.i("OCRPredictorNative", "True");
        loadLibrary();
        Log.i("OCRPredictorNative", "False");
        nativePointer = init(config.detModelFilename, config.recModelFilename, config.cpuThreadNum, config.cpuPower);
