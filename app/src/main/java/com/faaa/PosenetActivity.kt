...
class PosenetActivity :
  ...
  private var paint_red = Paint()
  private var paint_yellow = Paint()
  private var paint_blue = Paint()
  private var paint_green = Paint()
  ...
  public fun setPaint() {
    ...
    paint_red.textSize = 80.0f
    paint_red.strokeWidth = 8.0f

    paint_yellow.color = Color.YELLOW
    paint_yellow.textSize = 80.0f
    paint_yellow.strokeWidth = 8.0f

    paint_blue.color = Color.BLUE
    paint_blue.textSize = 80.0f
    paint_blue.strokeWidth = 8.0f


    paint_green.color = Color.GREEN
    paint_green.textSize = 80.0f
    paint_green.strokeWidth = 8.0f
  }
  ...
  private fun draw(canvas: Canvas, person: Person, bitmap: Bitmap) {
    ...
    for (keyPoint in person.keyPoints) {
      ...
      if (keyPoint.score > minConfidence) {
        ...
        canvas.drawCircle(adjustedX, adjustedY, circleRadius, paint_green)
      }
    }
    ...
    */
    ...
    for (line in bodyJoints) {
      ...
      if (
        ...
        if ( bodyJoints.indexOf(line) %2 == 0 )
        canvas.drawLine(
    ...
    canvas.drawText(
      "推理耗时: %.2f ms".format(posenet.lastInferenceTimeNanos * 1.0f / 1_000_000),
      (15.0f * widthRatio),
      (253.0f * heightRatio),
      paint_green
    )
