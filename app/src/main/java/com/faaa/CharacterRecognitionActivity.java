...
public class CharacterRecognitionActivity extends AppCompatActivity {
    ...
    protected EditText tvOutputResult;
    ...
    protected CharacterRecognitionPredictor predictor = new CharacterRecognitionPredictor();
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case RESPONSE_LOAD_MODEL_FAILED:
                        pbLoadModel.dismiss();
                        Toast.makeText(CharacterRecognitionActivity.this, "Load model failed!", Toast.LENGTH_SHORT).show();
                        onLoadModelFailed();
                        break;
                    ...
                    case RESPONSE_RUN_MODEL_FAILED:
                        pbRunModel.dismiss();
                        Toast.makeText(CharacterRecognitionActivity.this, "Run model failed!", Toast.LENGTH_SHORT).show();
                        onRunModelFailed();
                        break;
                    default:
                        break;
    ...
    public void loadModel() {
        ...
        Log.i(TAG, "loadModal okay");
    }

    public void runModel() {
        Log.i(TAG, "start to run Model......");
        pbRunModel = ProgressDialog.show(this, "", "Running model...", false, false);
        sender.sendEmptyMessage(REQUEST_RUN_MODEL);
    }

    public boolean onLoadModel() {
        return predictor.init(CharacterRecognitionActivity.this, modelPath, labelPath, cpuThreadNum,
                cpuPowerMode,
                inputColorFormat,
    ...
    public void onLoadModelSuccessed() {
        ...
        try {
            ...
            Toast.makeText(CharacterRecognitionActivity.this, "Load image failed!", Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }
    }
    ...
    public void onSettingsClicked() {
        startActivity(new Intent(CharacterRecognitionActivity.this, SettingsActivity.class));
    }
    ...
    private void takePhoto() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            try {
                ...
                Log.e("CharacterRecognitionActivity", ex.getMessage(), ex);
                Toast.makeText(CharacterRecognitionActivity.this,
            ...
            switch (requestCode) {
                case OPEN_GALLERY_REQUEST_CODE:
                    ...
                    try {
                        ...
                        open_exif = new ExifInterface(resolver.openInputStream(uri));
                        int open_orientation = open_exif.getAttributeInt(ExifInterface.TAG_ORIENTATION,
                                ExifInterface.ORIENTATION_UNDEFINED);
                        image = Utils.rotateBitmap(image, open_orientation);
