...
Java_com_faaa_OCRPredictorNative_init(JNIEnv *env, jobject thiz,
...
Java_com_faaa_OCRPredictorNative_forward(JNIEnv *env, jobject thiz,
...
Java_com_faaa_OCRPredictorNative_release(JNIEnv *env, jobject thiz,
                                         jlong java_pointer){
    if (java_pointer == 0) {
        LOGE("JAVA pointer is NULL");
        return;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_faaa_OCRPredictorNative_destory(JNIEnv *env, jobject thiz,
                                                               jlong java_pointer){
    if (java_pointer == 0) {
        LOGE("JAVA pointer is NULL");
        return;
